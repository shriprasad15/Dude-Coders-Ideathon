...
def run_inference_fallback(
    ...
    audit_dir = os.path.join(output_dir, "images")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default="artefacts/test", help="Output directory for results and images")
    parser.add_argument('--model', type=str, default="trained_model/model.pt", help="Path to model weights")
